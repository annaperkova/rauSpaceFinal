(() => {
    ...
    if (elementExists != null) {
        ...
        function init() {
            var myMap = new ymaps.Map("map", {
                controls: [],
                center: [ 55.73005056900001, 37.56407749999998 ],
                zoom: 12
            });
            let myPlacemark = new ymaps.Placemark([ 55.73005056900001, 37.56407749999998 ], {}, {
                hasBalloon: false,
    ...
    elementExists = document.getElementById("map2");
    if (elementExists != null) {
        ymaps.ready(init);
        function init() {
    ...
    function initSliders() {
        //! PAGE HOME - SECTION REVIEWS - REVIEWS__SLIDER
        ...
        //! PAGE HOME - SECTION REVIEWS - REVIEWS-VIDEO__SLIDER
                new core(".reviews-video__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".reviews-video__btn-prev",
                nextEl: ".reviews-video__btn-next"
            },
            on: {}
        });
        //! PAGE HOME - SECTION PAKET - PAKET__SLIDER
                new core(".paket__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".paket__btn-prev",
                nextEl: ".paket__btn-next"
            },
            on: {}
        });
        //! PAGE HOME - SECTION OTHER - OTHER__SLIDER
                new core(".other__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        //! PAGE HOME - SECTION BLOG - BLOG__SLIDER
        ...
        //! PAGE HOME - SECTION MEDIA - MEDIA__SLIDER
                new core(".media__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".media__btn-prev",
                nextEl: ".media__btn-next"
            },
            on: {}
        });
        //! PAGE HOME - SECTION SERVICES - SERVICES__SLIDER
        ...
        //! PAGE SERVICES - SECTION STAGES - STAGES__SLIDER
            ...
            speed: 800,
            navigation: {
                prevEl: ".stages__btn-prev",
                nextEl: ".stages__btn-next"
            },
            on: {}
        });
        //! PAGE SERVICES - SECTION TARIFF - SERVICE__SLIDER
                new core(".service__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    const icons = document.querySelectorAll(".income__brand");
    icons.forEach((icon => {
